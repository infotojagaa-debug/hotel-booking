...
import { FaFileInvoiceDollar, FaCheckCircle, FaDownload, FaRegCreditCard, FaHistory, FaPlusCircle } from 'react-icons/fa';
...
const CustomerPayments = () => {
    ...
    useEffect(() => {
        ...
        API.get('/bookings/mybookings')
            .then(({ data }) => {
                // Sort by createdAt descending to show most recent first (Real-Time feel)
        ...
        <div className="animate-in fade-in duration-600">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="cd-welcome-sub">Monitor your real-time transactions and download your invoices.</p>
                </div>
                <div className="flex items-center gap-3 py-2 px-4 bg-[#f5f3ff] rounded-2xl border border-indigo-50">
